...
import { Modal, TextInput, Button, Menu, Portal, Title } from 'react-native-paper';
...
const AlterarConfiguracao = () => {
    ...
    const { configuracao, carregarConfiguracao, atualizarServidor } = useConfiguracao();
    ...
    return (
        <>
            ...
            <Portal>
                <Modal style={styles.modalContainer} visible={modalVisible} onDismiss={closeModal} contentContainerStyle={containerStyle}>
