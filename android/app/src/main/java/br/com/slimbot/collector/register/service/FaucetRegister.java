...
public class FaucetRegister {

    private final static String LOG_TAG = "FaucetRegister";
    ...
    public FaucetRegister(Carteira carteira, int codigoFaucet, Configuracao configuracao) {
    ...
    public int verifyRegister() {
        ...
        try {
            DadosPaginaVO dadosPaginaVO = faucetApiClient.getCadastroPage(carteira.getRefer());
